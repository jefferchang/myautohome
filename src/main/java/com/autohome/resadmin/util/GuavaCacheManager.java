...
import com.autohome.resadmin.dao.BaseCache;
...
public class GuavaCacheManager {
        ...
        private static Map<String, ? extends BaseCache<Object, Object>> cacheNameToObjectMap = null;
        /**
         * 获取所有BaseCache子类的实例，即所有的Guava Cache对象
         * @return
         */
        @SuppressWarnings("unchecked")
        private static Map<String, ? extends BaseCache<Object, Object>> getCacheMap(){
            try {
                if(cacheNameToObjectMap==null){
                    cacheNameToObjectMap = (Map<String, ? extends BaseCache<Object, Object>>) SpringContextUtil.getBeanOfType(BaseCache.class);
                }
            }catch (Exception e){
                e.printStackTrace();
            }
         ...
         * @return
         */
        private static BaseCache<Object, Object> getCacheByName(String cacheName){
            return (BaseCache<Object, Object>) getCacheMap().get(cacheName);
        }
        /**
         * 获取所有缓存的名字（即缓存实现类的名称）
         * @return
        ...
        private static Map<String, Object> getCacheStatsToMap(String cacheName) {
            ...
            BaseCache<Object, Object> cache = getCacheByName(cacheName);
